    ...
    JqTreeWidget.prototype._loadDataFromUrl = function(url_info, parent_node, on_finished) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
        	if(_this.rspCode&&_this.rspCode<=0){
        		if(_this.rspCode&&_this.rspCode==-2){window.top.location.href=window.top.location.href.substring(0,window.top.location.href.indexOf("platform.do"));return;}
    			window.message({title:"提示信息",text: _this.rspMsg});
    			return;
    		}
