            ...
            <div class="menubar" style="">
                <div id="nxbbbb" class="nx-menubutton nx-dropdown" style="min-width: 136px;">
                    <img class="user-icon" src="" style=""
                         alt="" />
                    <label></label>
<!--                     <div class="message-mas"></div> -->
                    <div class="nx-dropdown-content" style="display:none"><ul>
                            <li><h4>您有 1 条未读消息</h4></li>
                            <li style="display:none;"><a actiontype="message" tabindex="-1" href="javascript:;" class="main-link"><i class="fa fa-bullhorn"></i><span style="white-space: pre-line;display: inline-block;padding-right: 12px;">背景肯德基有限公司算税完成</span></a></li>
                            <li><a actiontype="message" tabindex="-1" href="javascript:;" class="main-link"><i class="fa fa-th-list"></i>查看全部</a></li>
                            <li><h4>基本资料</h4></li>
        ...
        <div class="nx-content" style="overflow: hidden;">
            ...
            <iframe id="contentFrame" name="contentFrame"
                    ...
                    marginwidth="0" marginheight="0" src="pages/dashboard.html"></iframe>
        </div>
