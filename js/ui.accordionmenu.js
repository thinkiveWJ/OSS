    ...
    $.widget("ui.accordionMenu", {
        ...
        options: {
            ...
            // delete osource.menus;
             $("<div>").addClass("menu-title").text(osource.menuName).data(osource).appendTo($el);
            for (var i = 0, len = menus.length; i < len; i++) {
                ...
                if (menuitem.cls && menuitem.cls !== "") {
                    conHtml = '<i class="' + menuitem.cls + '"></i>' + menuitem.menuName;
                } else {
                    conHtml = menuitem.menuName;
                }
                ...
                if (chitems && chitems.length !== 0) {
                    ...
                    $temel.addClass(menuitem.open?"open":"fold");
                    var $innerUl = $("<ul>"), icAry = [];
                    for (var ti = 0, tlen = chitems.length; ti < tlen; ti++) {
                        var tiItemm = chitems[ti],
                            $imenuT = $("<li>");
                        $tiLink = $('<a tabindex="-1" href="javascript:;">' + tiItemm.menuName + '</a>').data(tiItemm);
            ...
            /*****wj 2016-07-28 start*********/
            $(".nx-left ul li:eq(0) a").trigger('click');
            $(".nx-left ul li:eq(0) ul li:eq(0) a").trigger('click');
            /*****wj 2016-07-28 end*********/
            ...
            if ($trt.hasClass("nohover")) {
                ...
                if ($par.hasClass("open")) {
                    ...
                    /*****wj 2016-07-28 start*********/
                    $par.find("ul li:eq(0) a").trigger('click');
                    /*****wj 2016-07-28 end*********/
                }
