...
(function($){
		...
		asyncNode: function(setting, node, isSilent, callback) {
			...
			$.ajax({
				...
				success: function(msg) {
					if(msg.rspCode&&msg.rspCode<=0){
						if(msg.rspCode&&msg.rspCode==-2){window.top.location.href=window.top.location.href.substring(0,window.top.location.href.indexOf("platform.do"));return;}
		    			window.message({title:"提示信息",text: msg.rspMsg});
		    			return;
		    		}
	...
	$.fn.zTree = {
		...
		init: function(obj, zSetting, zNodes,delayFun) {
